...
"_ATLauncher","_truck","_AA","_AAA","_ATLauncher","_AALauncher" "_ucav"];
...
["a UCAV Sentinel", "B_UAV_05_F"],
["an ATGM UCAV Sentinel", "Land_Sun_chair_F"],
...
if (_reward isKindOf "Land_Sun_chair_F") then {
	//a UCAV with ATGMs
	//created by McKillen
	_ucav = createVehicle ["B_UAV_05_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
	_ucav allowDamage false;
	_ucav setDir 284;
	deleteVehicle _reward;
	_ucav removeMagazinesTurret ["PylonMissile_Bomb_GBU12_x1",[0]];
	_ucav removeWeaponTurret ["weapon_GBU12Launcher",[0]];
	_ucav removeMagazinesTurret ["PylonMissile_Bomb_GBU12_x1",[0]];
	_ucav removeWeaponTurret ["weapon_GBU12Launcher",[0]];
	_ucav addWeaponTurret ["weapon_AGM_65Launcher",[-1]];
	_ucav addMagazineTurret ["PylonMissile_Missile_AGM_02_x2",[-1]];
	_ucav addWeaponTurret ["weapon_AGM_65Launcher",[-1]];
	_ucav addMagazineTurret ["PylonMissile_Missile_AGM_02_x2",[-1]];
	createVehicleCrew _ucav;
	{_x addCuratorEditableObjects [[_ucav], false];} foreach adminCurators;
};
